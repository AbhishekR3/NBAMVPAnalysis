...
```{r loading data}
location <- "C:\\Users\\Abhishek Ramesh\\Google Drive\\1USF\\Fall 2018\\BSDS 100\\Final Project\\bsds.csv"
mvp_data <- read.csv(location, header = T, sep = ",")
...
ggplot(mvp_data, aes(x = MVP.Position, y = FT., fill = MVP.Position)) +
...
ggplot(mvp_data, aes(x= WS, y = Season)) + 
...
ggplot(mvp_data, aes(x = Finals.Finish, y = Win..)) + 
...
```{r 14}
ggplot(mvp_data, aes(x = Season, y = PTS)) +
  geom_col() + geom_smooth(method = "loess", formula = y ~x) + theme_classic()

ggplot(mvp_data, aes(x = Season, y = AST)) +
  geom_col() + geom_smooth(method = "loess", formula = y ~x) + theme_classic()

ggplot(mvp_data, aes(x = Season, y = TRB)) +
  geom_col() + geom_smooth(method = "loess", formula = y ~x) + theme_classic()

ggplot(mvp_data, aes(x = Season, y = Age)) +
  geom_col() + geom_smooth(method = "loess", formula = y ~x) + theme_classic()

ggplot(mvp_data, aes(x = Season, y = Win..)) +
  geom_col() + geom_smooth(method = "loess", formula = y ~x) + theme_classic()

ggplot(mvp_data, aes(x = Season, y = MVP.Height..ft.)) +
  geom_col() + geom_smooth(method = "loess", formula = y ~x) + theme_classic()

ggplot(mvp_data, aes(x = Season, y = Conf.Seed)) +
  geom_col() + geom_smooth(method = "loess", formula = y ~x) + theme_classic()

ggplot(mvp_data, aes(x = Season, y = Finals.Finish)) +
  scale_x_discrete() + geom_col() + geom_smooth(method = "loess", formula = y ~x) +
  theme_classic()

ggplot(mvp_data, aes(x = Season, y = MVP.Position)) +
  scale_x_discrete() + geom_col() + geom_smooth(method = "loess", formula = y ~x) +
  theme_classic()
```
...
ggplot(mvp_data, aes(x = PTS, y = WS)) +
